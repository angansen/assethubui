                    ...
                    <Container fluid={false}>
                        <Row>
                            <div className="mb40">
                                ...
                                <h5 className="col-md-12 mb20">Use Case: Asset Search & Request for Demo</h5>
                                <Col md={10}>
                                    <iframe id="kmsembed-0_39k6jvkd" width="608" height="402" src='https://otube.oracle.com/embed/secure/iframe/entryId/0_7qk9wv49/uiConfId/43012852' class="kmsembed" allowfullscreen webkitallowfullscreen mozAllowFullScreen allow="autoplay *; fullscreen *; encrypted-media *" frameborder="0" ></iframe>
                                </Col>
